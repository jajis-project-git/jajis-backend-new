...
urlpatterns = [
    ...
    path('event-hall/', views.EventhallBookingView.as_view(), name='event_hall_booking'),
    path('event-hall/booked-dates/', views.EventhallBookedDatesView.as_view(), name='event_hall_booked_dates'),
